...
<div class="page2">
  ...
  <div class="section">
    ...
    <p class="tc-item">6. <strong>Credit Score System</strong> — Every Borrower starts with a credit score of 750 (max 1,000). +15 points per confirmed on-time installment; -10 points per late installment; +25 bonus points upon full loan repayment; -150 points upon default. Credit scores determine borrower tier, loan limit level, and Security Hold rate.</p>
    <p class="tc-item">7. <strong>Loan Limit &amp; Level System</strong> — Level 1 (first loan): ₱5,000. Level 2 (after 1 clean loan): ₱7,000. Level 3 (after 2 clean loans): ₱9,000. Level 4 (after 3 clean loans): ₱10,000 maximum. A "clean loan" means fully repaid with no defaults. Upgrades require a credit score of at least 750.</p>
    <p class="tc-item">8. <strong>Rebate Credits &amp; Early Payment Incentive</strong> — If the Borrower pays the final installment at least 7 to 14 days before its due date, a fixed rebate of 1% of the original loan amount is credited to their Rebate Credits balance. The rebate rate is fixed at 1% regardless of how many days early payment is made, provided the minimum 7-day threshold is met. Rebate Credits can be withdrawn once the balance reaches ₱500, subject to admin approval.</p>
    <p class="tc-item">9. <strong>Data Privacy</strong> — The Borrower's personal information is collected and processed solely for the administration of this loan in compliance with Republic Act No. 10173 (Data Privacy Act of 2012). Data will not be shared with third parties without consent except as required by law.</p>
    <p class="tc-item">10. <strong>Program Rules</strong> — Only one active loan is permitted per Borrower at a time. The Lender reserves the right to approve, reject, or adjust any loan application at its sole discretion. MoneyfestLending reserves the right to amend these terms at any time with notice via the Borrower Portal or email.</p>
    <p class="tc-item">11. <strong>Governing Law</strong> — This agreement shall be governed by the laws of the Republic of the Philippines. Any dispute shall first be referred to barangay conciliation under Republic Act No. 7160 (Katarungang Pambarangay Law). If unresolved, disputes shall be brought before the appropriate Philippine courts. By signing, the Borrower expressly acknowledges and agrees to MoneyfestLending's right to pursue legal remedies in cases of default or non-payment.</p>
  </div>
