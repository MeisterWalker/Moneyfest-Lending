              ...
              <div style={{ padding: '24px 28px', overflowY: 'auto', flex: 1, lineHeight: 1.85, fontSize: 13, color: '#8892B0' }}
                ...
                {(() => {
                  const installmentTerms = [
                    ...
                    { title: '6. Early Payoff Rebate Credits', body: 'If your final installment is paid at least 7 days before its due date, you will receive a flat ₱50 rebate credited to your Rebate Credits balance, regardless of loan amount. The rebate applies only to the final installment. Rebate Credits can be withdrawn once the balance reaches ₱500, subject to admin approval.' },
