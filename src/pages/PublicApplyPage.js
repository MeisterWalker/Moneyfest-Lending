            ...
            <div style={{ background: '#141B2D', border: '1px solid rgba(99,102,241,0.3)', borderRadius: 20, width: '100%', maxWidth: 560, maxHeight: '85vh', display: 'flex', flexDirection: 'column' }}>
              ...
              <div style={{ padding: '24px 28px', overflowY: 'auto', flex: 1, lineHeight: 1.85, fontSize: 13, color: '#8892B0' }}
                ...
                {[
                  ...
                  { title: '13. Governing Law & Legal Remedies', body: 'These Terms & Conditions are governed by the laws of the Republic of the Philippines, including Republic Act 3765, Republic Act 10173, and Republic Act 9474.' },
                ].map((sec, i) => (
