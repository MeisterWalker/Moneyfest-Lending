...
export default function TermsPage() {
  ...
  const qlSections = [
    { num: 1, title: 'Nature of QuickLoan', body: 'QuickLoan is a short-term cash loan offered exclusively to active team members. The maximum loan amount is \u20b13,000. Unlike the Installment Loan, QuickLoan has no fixed term or installment schedule \u2014 interest accrues daily and the borrower may settle at any time.' },
    { num: 2, title: 'Interest Rate & Daily Accrual', body: 'The monthly rate is 10%, computed as a daily rate of 0.3333%/day (10% \u00f7 30). Interest accrues on the outstanding principal from release. On a \u20b13,000 loan this equals \u20b110.00/day. Interest is not compounded.' },
    { num: 3, title: 'Pay Anytime \u2014 Early Settlement', body: 'The Borrower may settle the full balance at any time. Interest stops accruing on the day payment is confirmed. There is no prepayment penalty.' },
    { num: 4, title: 'Day 15 Target Due Date', body: 'The target due date is 15 calendar days from release. On a \u20b13,000 loan: \u20b13,000 + \u20b1150 interest = \u20b13,150 total. Paying by Day 15 closes the loan with no additional fees.' },
    { num: 5, title: 'Day 15 Missed \u2014 Extension Fee', body: 'If the Borrower does not pay by Day 15, a one-time Extension Fee of \u20b1100 is charged. The admin collects accrued 15-day interest + \u20b1100 fee. The principal rolls to Day 30 and interest continues to accrue daily.' },
    { num: 6, title: 'Day 30 Hard Deadline & Penalty', body: 'Day 30 from release is the absolute final deadline. After Day 30, a \u20b125.00/day penalty accrues with no cap, in addition to the continuing daily interest. Example on Day 35: \u20b13,000 + \u20b1350 interest + \u20b1100 ext fee + \u20b1125 penalty = \u20b13,575.' },
    { num: 7, title: 'No Security Hold', body: 'QuickLoan carries no Security Hold deduction. The full approved loan amount is released to the Borrower.' },
    { num: 8, title: 'Full Payoff Only', body: 'QuickLoan requires full settlement of the outstanding balance in a single payment. Partial payments toward the principal are not accepted.' },
    { num: 9, title: 'One Active Loan at a Time', body: 'A Borrower may not hold more than one active loan at a time, regardless of type.' },
    { num: 10, title: 'Credit Score', body: 'QuickLoan activity is tracked internally. A QuickLoan settled by Day 15 is recorded as a clean closure. Extension fees and penalties are recorded in the Borrower loan history.' },
    { num: 11, title: 'Data Privacy (RA 10173)', body: 'Personal information is collected and processed solely for loan administration, in compliance with Republic Act No. 10173 (Data Privacy Act of 2012).' },
    { num: 12, title: 'Governing Law', body: 'This agreement is governed by Philippine law including RA 3765, RA 10173, and RA 8792. Disputes shall first be referred to barangay conciliation under RA 7160. MoneyfestLending is a private colleague lending program, not a BSP-regulated institution.' },
  ]
          ...
          {qlSections.map((s, i) => (
            <div key={i} className="print-section" style={{ background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(245,158,11,0.12)', borderRadius: 12, padding: '18px 20px', marginBottom: 14 }}>
              <div style={{ display: 'flex', alignItems: 'flex-start', gap: 12 }}>
                <div style={{ width: 28, height: 28, borderRadius: 7, background: 'rgba(245,158,11,0.15)', border: '1px solid rgba(245,158,11,0.3)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: 'Space Grotesk', fontWeight: 800, fontSize: 12, color: '#F59E0B', flexShrink: 0 }}>{s.num}</div>
                <div>
                  <div style={{ fontFamily: 'Space Grotesk', fontWeight: 700, fontSize: 15, color: '#F0F4FF', marginBottom: 6 }} className="print-highlight">{s.title}</div>
                  <div style={{ fontSize: 13, color: '#8892B0', lineHeight: 1.75 }} className="print-body">{s.body}</div>
                </div>
              </div>
            </div>
          ))}
