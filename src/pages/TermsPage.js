      ...
      {termsTab === 'installment' && (
        <div className="print-container" style={{ maxWidth: 860, margin: '0 auto', padding: '48px 28px 80px' }}>
          ...
          {[
            ...
            { num: '6', title: 'Early Payoff Rebate Credits', content: 'MoneyfestLending rewards Borrowers who settle their final installment ahead of schedule:', items: [{ term: 'Flat ₱50 Rebate', def: 'A flat rebate of ₱50 is credited to Rebate Credits when the final installment is paid at least 7 days before its due date, regardless of loan amount.' }, { term: 'Rebate Credits Withdrawal', def: 'Rebate Credits can be withdrawn once the balance reaches a minimum of P500. Withdrawal requests are subject to admin approval.' }, { term: 'Scope', def: 'The rebate applies exclusively to the final installment of the loan.' }] },
