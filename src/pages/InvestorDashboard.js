  ...
  return (
    <div className="modal-overlay agreement-modal-root" style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.92)', backdropFilter: 'blur(12px)', zIndex: 1000, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '20px 0' }}>
      <div style={{ position: 'relative', width: '95%', maxWidth: 900, maxHeight: '95vh', overflowY: 'auto', background: '#fff', borderRadius: 12 }}>
        ...
        {!investor.signed_at && (
          <div style={{ padding: '0 40px 20px', textAlign: 'center' }} className="no-print">
            <div style={{ background: '#FFF7ED', border: '1px solid #FED7AA', padding: '16px 20px', borderRadius: 12, display: 'inline-block' }}>
              <p style={{ fontFamily: 'Inter', fontSize: 13, color: '#9A3412', margin: '0 0 10px' }}>
                <strong>Official Signature Required:</strong> Please sign with your digital pen to activate your dashboard.
              </p>
              <button 
                onClick={() => setShowPad(true)}
                style={{ background: '#EA580C', color: '#fff', border: 'none', padding: '8px 20px', borderRadius: 8, fontFamily: 'Inter', fontWeight: 700, cursor: 'pointer', display: 'flex', alignItems: 'center', gap: 10, margin: '0 auto' }}>
        ...
        <InvestorMoa 
          investor={investor} 
          onSign={() => setShowPad(true)} 
        />
      </div>

      {showPad && (
        <div style={{ position: 'fixed', inset: 0, zIndex: 1100, background: 'rgba(0,0,0,0.85)', display: 'flex', alignItems: 'center', justifyContent: 'center' }} className="no-print">
          <SignaturePad 
            onSave={(data) => { onSign(data); setShowPad(false) }}
