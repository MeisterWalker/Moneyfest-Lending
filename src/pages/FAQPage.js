...
export default function FAQPage() {
  ...
  const faqByCategory = {
    eligibility: [
      ...
      { q: 'Do I need to submit a valid ID?', a: 'Yes. Upload a clear photo of the front and back of any government-issued ID. Accepted IDs: Philippine National ID (PhilSys), Passport, Driver's License, SSS/GSIS ID, PhilHealth ID, Voter's ID, Postal ID, TIN ID, and PRC ID. Both front and back must be visible and legible.'s License, Postal ID, Voter\'s ID, or any other government-issued photo ID. Applications without a valid ID submission will not be processed.' },
    ],
    amounts: [
