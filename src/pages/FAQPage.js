...
export default function FAQPage() {
  ...
  const faqByCategory = {
    eligibility: [
      ...
      { q: 'What is the credit score system?', a: 'Every borrower starts with a credit score of 750. Your score goes up by 15 points for each on-time payment, and you earn a bonus of 25 points when you fully pay off a loan. If a payment is late, your score drops by 10 points. A loan default deducts 150 points. Your credit score directly affects your Security Hold rate and your borrower tier — the higher your score, the lower your hold and the better your perks.' },
      { q: 'What are the borrower tiers and perks?', a: 'LoanMoneyfest has 4 borrower tiers based on your clean loan history and credit score. 🌱 New — starting tier, 10% Security Hold. ⭐ Trusted — after 1 clean loan, 8% hold. 🤝 Reliable — after 2 clean loans, 6% hold. 👑 VIP — after 3 clean loans with score 780+, only 5% hold. Higher tiers also unlock higher loan limits up to ₱10,000. The better you pay, the better your perks get.' },
      { q: 'How do I reduce my Security Hold rate?', a: 'Your Security Hold rate is automatically reduced as your credit score improves. Pay every installment on time to earn +15 points per payment. Complete a full loan on time to earn an additional +25 bonus points. Once your score crosses the next tier threshold, your Security Hold rate drops on your next approved loan. VIP borrowers with 780+ score enjoy the lowest rate of just 5%.' },
