...
export default function FAQPage() {
  ...
  const faqByCategory = {
    ...
    payments: [
      ...
      { q: 'Can I earn rewards for paying early?', a: 'Yes! Pay your final installment at least 7 days early and earn a flat ₱50 rebate credited to your Rebate Credits. The rebate is the same regardless of loan amount. It only applies to the last installment and is automatically credited when the admin records your payment.' },
    ],
    release: [
      ...
      <div style={{ background: 'linear-gradient(135deg,#0d1226,#141B2D)', borderBottom: '1px solid rgba(139,92,246,0.2)', padding: '20px 24px' }}>
        <div style={{ maxWidth: 860, margin: '0 auto', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 12 }}>
          ...
          <div style={{ display: 'flex', gap: 8 }}>
            ...
            <a href="/partners" style={{ display: 'flex', alignItems: 'center', gap: 6, padding: '8px 16px', borderRadius: 10, background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.08)', color: '#7A8AAA', fontSize: 13, fontWeight: 600, textDecoration: 'none', whiteSpace: 'nowrap' }}>
              Work With Us
            </a>
