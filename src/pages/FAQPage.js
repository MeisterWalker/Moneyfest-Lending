...
export default function FAQPage() {
  ...
  const faqByCategory = {
    eligibility: [
      ...
      { q: 'What is the Security Hold?', a: 'When your loan is approved, 20% of the loan amount is held back as a Security Hold. For example, if you borrow ₱5,000 you will receive ₱4,000 and ₱1,000 is held. Interest is still computed on the full ₱5,000. Once you fully pay your 4th installment, the Security Hold is automatically credited back to your Rebate Credits. It is not a fee — you get it back in full.' },
